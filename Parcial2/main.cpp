...
vector<int> llenar (string filename, int inix, int iniy, int endx, int endy)
{
...
int main()
{
    vector<int> prom;
    string nombre;
    cout<<"Ingrese el nombre de la imagen a cargar: "<<endl;
    cin>>nombre;
    QImage im(nombre.c_str() );
    ...
    for(int i = 0; i<=5;i++)
    {
       ...
       for (int z = 1; z<=13;z+=2)
       {
         ...
         archivo<<"  {"<<endl;
         prom = llenar (nombre,inix,iniy,endx,endy);
